...
document.getElementById('exportBtn')?.addEventListener('click', function() {
    ...
    if (document.readyState === 'loading') {
        ...
        // ==================== LOGOUT BUTTON (FIXED - WORKING VERSION) ====================
    (function() {
        ...
        if (logoutBtn) {
            ...
            newLogoutBtn.addEventListener('click', async (e) => {
                ...
                const confirmed = confirm('⚠️ Are you sure you want to logout?');
                if (!confirmed) return;
                
                try {
                    // Show loading state
                    newLogoutBtn.style.opacity = '0.5';
                    newLogoutBtn.style.cursor = 'wait';
                    newLogoutBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i><span>Logging out...</span>';
